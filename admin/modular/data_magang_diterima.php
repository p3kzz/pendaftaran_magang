...
<section class="content-header">
    <h1> Data Magang Diterima </h1>
    <ol class="breadcrumb">
        <li><a href="index.php?dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Data Magang Diterima</li>
    </ol>
</section>
                ...
                <table id="myTable" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            echo "<tr><td colspan='8' class='text-center'>Belum ada data diterima</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
